...
/**
 * Process refund for admin orders
 */
class Refund extends \Magento\Framework\Webapi\Rest\Controller
{
    /**
    ...
    public function execute()
    {
        try {
            ...
            $this->validateRefundData($paymentData);

            $result = $this->paymentProcessor->refund($paymentData);
     ...
     */
    private function validateRefundData(array $data)
    {
