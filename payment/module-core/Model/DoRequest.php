...
use CyberSource\Core\Service\PropertiesUtility;
use CyberSource\Core\Service\SecurityUtility;
use InvalidArgumentException;
use CyberSource\Core\Model\LoggerInterface;
Use DOMDocument;
use DOMXPath;

class DoRequest extends \SoapClient
{
    ...
    public function __construct(
        ...
        $this->propertiesUtility = $objectManager->get('\CyberSource\Core\Service\PropertiesUtility');
        $this->securityUtility = $objectManager->get('\CyberSource\Core\Service\SecurityUtility');
     ...
     public function __doRequest($request, $location, $action, $version, $oneWay = false)
    {
        ...
        $this->logger->debug('SoapXml:'. $request);
