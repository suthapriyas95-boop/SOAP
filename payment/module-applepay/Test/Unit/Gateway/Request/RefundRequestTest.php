...
class RefundRequestTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->unit = $helper->getObject(
            \CyberSource\ApplePay\Gateway\Request\RefundRequest::class,
    ...
    public function testBuild()
    {
        ...
        $this->assertEquals([], $this->unit->build(['payment' => $this->paymentDataMock, 'amount' => 5]));
        try {
            $this->unit->build(['payment' => $this->paymentDataMock, 'amount' => 5]);
