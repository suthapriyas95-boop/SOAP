    ...
    function (
        ...
        return Component.extend({
            ...
            placeOrderWithSOP: function() {
                ...
                this.card_number = (encodeURIComponent(this.createHiddenInput('card_number', $(this.getSelector('cc_number')).val())));
                this.card_expiry_date = (encodeURIComponent(this.createHiddenInput(
                    'card_expiry_date',
                    ("0" + $(this.getSelector('expiration')).val()).slice(-2) + '-' + $(this.getSelector('expiration_yr')).val()))
                );
                this.card_cvn = (encodeURIComponent(this.createHiddenInput ('card_cvn', $(this.getSelector('cc_cid')).val())));
