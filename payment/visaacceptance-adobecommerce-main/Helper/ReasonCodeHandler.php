...
class ReasonCodeHandler
{
    ...
    /**
     * Map of reason codes to corresponding messages.
     *
     * @var array
     */
    private static $messages = [
        ...
        104 => "Declined - The merchantReferenceCode sent with this authorization request matches the
        ...
        200 => "Soft Decline - The authorization request was approved by the issuing bank but declined by 
                CyberSource because it did not pass the Address Verification Service (AVS) check.",
        201 => "Decline - The issuing bank has questions about the request. You do not receive an authorization
                code programmatically, but you might receive one verbally by calling the processor.",
        202 => "Decline - Expired card. You might also receive this if the expiration date you provided
        ...
        230 => "Soft Decline - The authorization request was approved by the issuing bank but 
                declined by CyberSource because it did not pass the card verification number (CVN) check.",
        ...
        235 => "Decline - The requested amount exceeds the originally authorized amount. Occurs, for example, 
                if you try to capture an amount larger than the original authorization amount.",
        ...
        246 => "Decline - The capture or credit is not voidable because the capture or credit information has
                already been submitted to your processor. Or, you requested a void for a type of transaction
        ...
        400 => "Soft Decline - Fraud sPayment exceeds threshold.",
        ...
        475 => "The cardholder is enrolled in Payer Authentication. Please authenticate the cardholder 
        ...
        520 => "Soft Decline - The authorization request was approved by the issuing bank but declined by 
    ...
    /**
     * Check if declined code
     *
     * @param string $code
     * @return bool
     */
    public function isDeclined($code)
    {
